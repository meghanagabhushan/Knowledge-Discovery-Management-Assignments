...
object SparkLDAMain {
  ...
  private def run(params: Params) {
    ...
    val topic_output = new PrintStream("data/ldaresults")
    ...
    val stopwordsMegha = Array("s","dont","between","can","cannot","buy","by","but",",","at","when","that","the","a","an","them","")
