...
//The CoreMap key for getting the sentences contained by an annotation. This key is typically set only on document annotations.
        ...
        if(question.equalsIgnoreCase("Retrieve all the topics related to hygyiene")){
            String reply= readFile("TopicsLDA");
            System.out.println(reply);
        }
    }
    public static String answerPasringLDA(String fileName,String keyword)throws IOException{
