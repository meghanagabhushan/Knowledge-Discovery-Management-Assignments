...
object OntContructorMain {
  def main(args: Array[String]): Unit = {
    ...
    val ontology = manager.createOntology(IRI.create(ONTOLOGYURI,"medical#"))
    //Prefix for all the entities
    val pm = new DefaultPrefixManager(null, null, ONTOLOGYURI+"medical#")
    ...
    val os = new FileOutputStream("data/medical.owl")
